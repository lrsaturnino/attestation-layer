...
def test_auxiliary_artifact_schemas_are_committed() -> None:
    ...
    assert (schema_dir / "controlled-requirement-semantics.schema.json").exists()
    ...
    assert (schema_dir / "formal-claim.schema.json").exists()
    assert (schema_dir / "formal-claim-lowering-report.schema.json").exists()
    assert (schema_dir / "gate-policy.schema.json").exists()
    assert (schema_dir / "impact-analysis.schema.json").exists()
    assert (schema_dir / "source-impact-analysis.schema.json").exists()
    ...
    assert (schema_dir / "semantic-agreement-report.schema.json").exists()
    assert (schema_dir / "semantic-translation-report.schema.json").exists()
    ...
    assert (schema_dir / "translation-repair-report.schema.json").exists()
