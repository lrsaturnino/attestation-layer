...
| 49 | Hash-bound review workflow | Implemented | `src/nlreq/review_workflow.py`, `schemas/approval-workflow.schema.json`, `schemas/review-checklist.schema.json` |
| 50 | Product refusal surface | Implemented | `src/nlreq/refusal.py`, `schemas/product-refusal-report.schema.json` |
...
| 54 | Contradiction taxonomy | Implemented | `src/nlreq/requirement_self_consistency.py`, `docs/contradiction-taxonomy.md` |
...
| 58 | TLA projection | Implemented | `src/nlreq/tla_projection.py`, `schemas/tla-projection-report.schema.json` |
| 59 | Counterexample normalization | Implemented | `src/nlreq/counterexample_normalization.py`, `schemas/counterexample-normalization-report.schema.json` |
...
| 63 | Code-to-spec manifest | Implemented | `src/nlreq/spec_drift.py`, `schemas/code-spec-manifest.schema.json` |
...
| 66 | Trace normalization | Implemented | `src/nlreq/trace_normalization.py`, `schemas/trace-normalization-report.schema.json` |
| 67 | Solidity adapter | Implemented | `src/nlreq/production_source_adapters.py`, `nlreq adapter-certify --language solidity` |
| 68 | Go adapter | Implemented | `src/nlreq/production_source_adapters.py`, `nlreq adapter-certify --language go` |
| 69 | TypeScript adapter | Implemented | `src/nlreq/production_source_adapters.py`, `nlreq adapter-certify --language typescript` |
| 70 | Rust or Java adapter | Implemented | `src/nlreq/production_source_adapters.py`, `nlreq adapter-certify --language rust` |
| 71 | Adapter certification | Implemented | `src/nlreq/adapter_certification.py`, `schemas/adapter-certification-report.schema.json` |
...
| 76 | Benchmark evaluation | Implemented | `src/nlreq/benchmark_reporting.py`, `schemas/benchmark-evaluation-report.schema.json` |
| 77 | Verification cache | Implemented | `src/nlreq/verification_cache.py`, `schemas/verification-cache-index.schema.json` |
| 78 | Waiver governance | Implemented | `src/nlreq/policy_governance.py`, `schemas/waiver-audit-report.schema.json` |
